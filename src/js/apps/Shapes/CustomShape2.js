...
export default class CustomShape extends Shape{
    ...
    update(dt = 1/60){
        ...
        this.x = window.innerWidth/2 + 100 * Math.cos(this.time );
        this.y = window.innerHeight/2 + 100 * Math.sin(this.time );
